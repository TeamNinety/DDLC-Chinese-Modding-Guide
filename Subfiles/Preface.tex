...
由于Ren'Py与Python密不可分，本书在介绍Ren'Py特性的同时，还讨论了基本Python用法，使二者成为有机的整体。书中介绍了Ren'Py的基本概念，通过简单明了的例子向读者展示Ren'Py的代码与知识。
...
\begin{itemize}
    \item 代码使用 14 点的 Sarasa Fixed SC 字体。背景为RGB颜色（235， 235， 235）。如：
...
本书的Ren'Py示例是在Windows 11 64 bit上使用Next分支与Ren'Py SDK 7.6.1开发的，在Future分支与Ren'Py SDK 8.0.3上进行过测试。

\subsubsection*{获取最新版指南及附属文件}
由于中国大陆网络的特殊性，对于某些资源您可以在此处下载附属文件：
\url{https://disk.monika.love/s/aNjSR}

本书的源码可在Github上获取：
\url{https://github.com/TeamNinety/DDLC-Chinese-Modding-Guide}
