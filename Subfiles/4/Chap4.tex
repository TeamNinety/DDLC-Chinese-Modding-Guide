...
打开编辑器的查找功能，搜索：\verb|define s = DynamicCharacter|，随后在这一行上面或下面增添例如上述的代码。
...
\begin{lstlisting}
# m means mod
image yuri m1a = im.Composite((960, 960), (0, 0), "mod_assets/images/yuri/1l.png", (0, 0), "mod_assets/images/yuri/1r.png", (0,0), "mod_assets/images/yuri/happy.png")
\end{lstlisting}
